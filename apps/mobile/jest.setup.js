...
jest.mock('./native/db', () => ({
  ...
  getWeeklyRecap: jest.fn(() => ({ weekKey: '2026-07-13', sessions: 3, volumeKg: 12000, xp: 420, sets: 40, prCount: 2, topLift: 'Bench Press', hasData: true })),
  getLastWorkoutDate: jest.fn(() => '2026-07-16'),
  getTodayPlan: jest.fn(() => ({ type: 'fresh', reason: 'No plan today — start fresh.' })),
  ...
  createTemplateFull: jest.fn(() => 1),
  createWeek: jest.fn(() => [1, 2, 3]),
  getTemplate: jest.fn(() => ({ id: 1, name: 'Push Day', dayOfWeek: 1, exercises: [
    { exerciseName: 'Bench Press', orderIndex: 0, targetSets: 4, targetReps: 8, targetRest: 90, muscleGroup: 'chest', equipment: 'barbell' },
  ] })),
  updateTemplate: jest.fn(),
  renameTemplate: jest.fn(),
  setTemplateDay: jest.fn(),
