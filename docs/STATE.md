...
Current sprint: **AURORA redesign — Phases 1–6 DONE**. App at v3.0.0.
...
**Next phases:** 7 — cinematics (level-up, PR, dungeon clear); 8 — long tail (Exercises, History, Achievements, Wrapped, Records, Settings).
